...
namespace MgAl2O4.Utils
{
    public class GithubUpdater
    {
        ...
        const string repoLink = "https://github.com/MgAl2O4/SINoCOLO/";
        ...
        private static string FindPendingUpdateFile()
        {
            ...
            Console.WriteLine("Update version check! current:" + updateVersion);
            ...
            try
            {
                ...
                foreach (string path in files)
                {
                    ...
                    if (!string.IsNullOrEmpty(versionStr))
                    {
                        ...
                        {
                            Console.WriteLine(">> found '" + path + "', version: " + versionNum);
